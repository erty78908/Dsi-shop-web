...
function initPage()
{
	...
	btnBack.onmouseup = "showPage( 'W_01.jsp' )";
    onload_scroll();
...
<div class="btn_base button_256x34" id="btnInfo1" shpbtn> 
    <script>if(MessageHeadlines[0].indexOf('[NEW]')==0){
				document.write('<img class="info_new" src="/tss/tss/common/images//new_update/new_s_US_EN.gif">');
			}
    </script>
...
<div class="preload" id="up_contents">
	...
	<div>
        ...
        <div class="up_message_scrollable">
            <div class="tx12">
			    <script type="text/JavaScript">
					document.write(MessageHeadlines[0].replace("[NEW]", '<img class="info_new" src="/tss/tss/common/images//new_update/new_s_US_EN.gif"><br>'));
				</script>
                <br>
				<script type="text/JavaScript">
	...
	<div>
        ...
        <div class="up_message_scrollable">
            <div class="tx12">
			    <script type="text/JavaScript">
					document.write(MessageHeadlines[1].replace("[NEW]", '<img class="info_new" src="/tss/tss/common/images//new_update/new_s_US_EN.gif"><br>'));
				</script>
                <br>
				<script type="text/JavaScript">
	...
	<div>
        ...
        <div class="up_message_scrollable">
            <div class="tx12">
			    <script type="text/JavaScript">
					document.write(MessageHeadlines[2].replace("[NEW]", '<img class="info_new" src="/tss/tss/common/images//new_update/new_s_US_EN.gif"><br>'));
				</script>
                <br>
				<script type="text/JavaScript">
