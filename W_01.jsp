...
.button_224x28 {
        width  : 224px;
        height : 28px;
        background-image : url(../common/images/button_autogen/button_224x28_all.gif);
}

.button_48x48 {
        width  : 48px;
        height : 48px;
        background-image : url(../common/images/button_autogen/button_48x48_all.gif);
}

.option_256x28 {
        width  : 256px;
        height : 28px;
        background-image : url(../common/images/button_autogen/option_256x28_all.gif);
}

.button_256x44 {
        width  : 256px;
        height : 44px;
        background-image : url(../common/images/button_autogen/button_256x44_all.gif);
}
...
function initPage()
{
    ...
    if ( newflag )
    {
        $("imgNewInfo").innerHTML = '<img src="/tss/tss/common/images//new_update/new_s_US_EN.gif">&nbsp';
    }
...
function initRecommendedTitles()
{
    ...
    title = new TitleInfo();
    title.titleId = '00030015484E4F45';

  
    title.titleImage = '/tss/ccs/00030015484E4F45/FFFD0011';
...
<div class="preload" id="up_contents">
    <div>
        ...
        <img class="bg_image" src="/tss/tss/common/images//shopx365_welcomePage.gif">
            <div id='shopWelcomeTitle' class='tx16 cBlue'>
            Nintendo DSi Shop</div>
    </div>
</div>

<img id="recommendFrame" src="/tss/tss/common/images//recommendFrame.gif"/>
<div class="btn_base button_224x28" id="btnRecommendList" shpbtn>
    <span class="btn_inner tx12">
        Recommended Titles</span>
</div>

<img id="new1" src="/tss/tss/common/images//new_update/new_s_US_EN.gif" style="display:none">
        <div class="btn_base button_48x48" id="btnRecommend1" shpbtn>
            <div id="soft1"></div>
        </div>
...
<div class="btn_base button_256x44" id="btnShopping" shpbtn>
    <img class="btnShopping_child1" src="/tss/tss/common/images//icon_bag.png"/>
    <img class="btnShopping_child2" src="/tss/tss/common/images//icon_bag.png"/>
